...
import SubServiceCategoryAdd from './sub-service-category-add';
...
const ServiceCategoryShow = () => {
  ...
  useEffect(() => {
    console.log('Wrong fetching', uuid);
  ...
  return (
    <>
      ...
      {!!categoryId && (
        <ServiceCategoryList
          type={data?.type === 'service' ? 'sub_service' : 'child_service'}
