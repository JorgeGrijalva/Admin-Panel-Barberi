...
const WorkingDays = ({
  ...
  return (
    <Form form={form} layout='vertical' onFinish={onFinish}>
      <Row gutter={[24, 24]}>
        <Col span={12}>
          <Card title={t('warehouse.working.days')} className='h-100'>
            <Row gutter={24}>
              <Col span={24}>
                    ...
                    return (
                      <div>
                        {fields.map((field, index) => (
                          <Row key={field.key} gutter={24} align='center'>
                            <Col span={7}>
        ...
        <Col span={12}>
          <Card title={t('warehouse.closed.days')} className='h-100'>
            <p>{t('warehouse.closed.days.text')}</p>
